  ...
  <>
    <Card className="px-2 mt-2 ">
      <CardContent className="flex  flex-col shadow-md bg-white px-5">
        <CardHeader className="text-3xl font-semibold font-serif">About Us</CardHeader>
      ...
      <Card className="px-2 mt-2 ">
      <CardContent className="flex  flex-col shadow-md bg-white px-5">
        <CardHeader className="text-3xl font-semibold font-serif">Our Vision</CardHeader>
